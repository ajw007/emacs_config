(defun color-theme-wombat ()
  ...
  (let ((color-theme-is-cumulative t))
	...
	(border-color . "hotPink"))
       ...
       (font-lock-constant-face ((t ( :foreground "lightGoldenRod3" :weight normal ))))
       (font-lock-doc-face ((t ( :foreground "cornsilk4" :weight normal ))))
       (font-lock-function-name-face ((t ( :foreground "palegreen3" :weight normal ))))
       (font-lock-keyword-face ((t ( :foreground "skyblue3" :weight normal ))))
       (font-lock-preprocessor-face ((t ( :foreground "salmon3" :weight normal ))))
       (font-lock-string-face ((t ( :foreground "burlywood" :weight normal))))
       (font-lock-type-face ((t ( :foreground "#cd9879" :weight normal ))))
       ...
       (jde-java-font-lock-constant-face ((t (:foreground "#BDB168"))))     (jde-java-font-lock-italic-face ((t (:foreground "cornSilk4" :slant italic))))
       ...
       (ecb-tag-header-face ((t (:background "#3d5450"))))
       ...
       ;; Auto-complete
       (ac-selection-face ((t ( :foreground "honeydew2" :background "steel blue"  :box nil))))
       (ac-menu-face ((t ( :foreground "honeydew2" :background "gray21" :box nil))))
